package ru.nordwest.nord.block.abstracts;
...
abstract public class AbstractMachina extends RotatebleContainerBlock {
        ...
        protected AbstractMachina(Material mat) {
                super(mat);
        }
        ...
        private boolean getWork(IBlockAccess world, int x, int y, int z) {
                AbstractEnergyMachina tile = (AbstractEnergyMachina) world.getTileEntity(x, y, z);
