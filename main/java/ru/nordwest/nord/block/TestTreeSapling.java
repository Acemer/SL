...
import ru.nordwest.nord.world.WorldGenTestTree;
...
public class TestTreeSapling extends BlockSapling {

	public TestTreeSapling() {
        float f = 0.4F;
    ...
    {
        if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(p_149878_1_, p_149878_5_, p_149878_2_, p_149878_3_, p_149878_4_)) return; // Какая-то непонятная фигня
