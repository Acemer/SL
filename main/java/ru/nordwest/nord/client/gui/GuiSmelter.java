...
public class GuiSmelter extends GuiMachine {
        ...
        public GuiSmelter(InventoryPlayer iPlayer, TileSmelter tileFlowing, EntityPlayer player) {
                super(new ContainerSmelter(iPlayer, tileFlowing));
        ...
        protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
                this.mc.renderEngine.bindTexture(new ResourceLocation(Nord.MODID + ":textures/gui/container/stone_smelter.png"));
                int x = (width - xSize) / 2;
