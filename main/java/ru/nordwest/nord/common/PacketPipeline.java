...
import ru.nordwest.nord.AbstractPacket;
...
public class PacketPipeline
	 ...
	 * 
	 * @param clazz
	 *            класс пакета, который необходимо зарегистрировать.
	 * 
	 ...
	 *            Пакет, который нужно отправить.
	 * @param player
	 *            Игрок, которому нужно отправить пакет.
	 */
