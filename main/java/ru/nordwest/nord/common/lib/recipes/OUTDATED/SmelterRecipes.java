package ru.nordwest.nord.common.lib.recipes.OUTDATED;
...
public class SmelterRecipes {
        ...
        public void smeltItemStack(String input1, int qual1, int quant1,
                ...
                smeltItemStack(RegisterMetal.getMetallIngot(input1, qual1, quant1),
                        RegisterMetal.getMetallIngot(input2, qual2, qual2),
                        RegisterMetal.getMetallIngot(output1, oqual1, oquant1),
                        RegisterMetal.getMetallIngot(output2, oqual2, oquant2),
                        percent, exp);
        ...
        public void smeltItemStack(String input1, int qual1, int quant1,
                ...
                smeltItemStack(RegisterMetal.getMetallIngot(input1, qual1, quant1),
                        RegisterMetal.getMetallIngot(input2, qual2, qual2),
                        RegisterMetal.getMetallIngot(output1, oqual1, oquant1), exp);
