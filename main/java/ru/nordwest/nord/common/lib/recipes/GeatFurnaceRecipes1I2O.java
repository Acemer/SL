package ru.nordwest.nord.common.lib.recipes;

import net.minecraft.item.ItemStack;
import ru.nordwest.nord.common.lib.recipes.Interfaces.IRecipes1I2O;
import ru.nordwest.nord.common.lib.recipes.abstracts.Recipe1I2O;
import ru.nordwest.nord.common.lib.recipes.abstracts.Recipes1I2O;

public class GeatFurnaceRecipes1I2O extends Recipes1I2O {
        ...
        public static IRecipes1I2O INSTANCE() {
                if (INSTANCE == null) {
                        INSTANCE = new GeatFurnaceRecipes1I2O();
                }
                return INSTANCE;
        }
}
